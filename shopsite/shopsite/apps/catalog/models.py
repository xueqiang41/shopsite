...
class Category(models.Model):
    ...
    meta_keywords = models.CharField("Meta 关键词",max_length=255,help_text='meta关键词，有利于SEO， 用逗号分隔')
    ...
    class Meta:
        db_table = 'categories'
        ordering = ['-created_at']
        verbose_name_plural = 'Categories'   #admin页面显示的信息
...
class Product(models.Model):
    ...
    categories = models.ManyToManyField(Category)  #多对对的关系
